...
Rails.application.config.assets.precompile += %w( admin.css admin.js _exam_new.js _sub_course_show.js _teachers.js modal_pdf.js managers.css managers.js course-3.js)
